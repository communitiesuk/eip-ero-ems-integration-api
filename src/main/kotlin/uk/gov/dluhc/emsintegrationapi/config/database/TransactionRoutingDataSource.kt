package uk.gov.dluhc.emsintegrationapi.config.database

import org.springframework.jdbc.datasource.lookup.AbstractRoutingDataSource
import uk.gov.dluhc.emsintegrationapi.config.database.TransactionRoutingDataSource.DataSourceType.READ_ONLY
import uk.gov.dluhc.emsintegrationapi.config.database.TransactionRoutingDataSource.DataSourceType.READ_WRITE
