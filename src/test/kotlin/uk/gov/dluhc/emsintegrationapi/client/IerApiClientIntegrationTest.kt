...
/**
* Note: Negative tests which throws errors/exceptions for [uk.gov.dluhc.emsintegrationapi.client.IerApiClient]
 * are covered as a part of Mockito unit tests in [uk.gov.dluhc.emsintegrationapi.client.IerApiClientTest]
 */
