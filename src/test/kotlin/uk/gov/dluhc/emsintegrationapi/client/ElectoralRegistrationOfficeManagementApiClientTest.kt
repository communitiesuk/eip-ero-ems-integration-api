...
internal class ElectoralRegistrationOfficeManagementApiClientTest {
    ...
    fun `should get Electoral Registration Office`() {
        // Given
        val eroId = uk.gov.dluhc.emsintegrationapi.testsupport.testdata.getRandomEroId()
        ...
        // Then
        Assertions.assertThat(ero).isEqualTo(expectedEro)
        Assertions.assertThat(clientRequest.value.url()).hasHost("ero-management-api").hasPath("/eros/$eroId")
    }
    ...
    fun `should not get Electoral Registration Office given API returns a 404 error`() {
        ...
        // Then
        Assertions.assertThat(ex.message).isEqualTo(expectedException.message)
        Assertions.assertThat(clientRequest.value.url()).hasHost("ero-management-api").hasPath("/eros/$eroId")
    }
