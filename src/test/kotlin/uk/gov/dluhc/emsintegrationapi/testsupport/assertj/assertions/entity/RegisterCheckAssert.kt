...
import uk.gov.dluhc.emsintegrationapi.testsupport.toRoundedUTCOffsetDateTime
...
class RegisterCheckAssert(private val actualJpaEntity: RegisterCheck?) :
    ...
    fun ignoringVersionField(): RegisterCheckAssert {
        ignoringFields += "personalDetail.address.version"
        return this
    }
