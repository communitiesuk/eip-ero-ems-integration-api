...
internal class PutProxyVoteApplicationIntegrationTest : IntegrationTest() {
    ...
    fun setup() {
        ...
        ClearDownUtils.clearDownRecords(
            proxyRepository = proxyApplicationRepository,
    ...
    fun `System rejects the request with status code 400 if the application id format is invalid`() {
        ...
        val responseSpec = apiClient!!.putEmsApplication("/proxyvotes/123", serialNumber = ERO_ID_1_CERTIFICATE_SERIAL)
    ...
    fun `System returns http status 404 if a given application does not exist`() {
        // When the EMS sends a put request to "/proxyvotes" with an application id APPLICATION_ID_3 and certificate serial number ERO_ID_1_CERTIFICATE_SERIAL and SUCCESS status
        val responseSpec =
            apiClient!!.putEmsApplication("/proxyvotes/$APPLICATION_ID_3", serialNumber = ERO_ID_1_CERTIFICATE_SERIAL)
    ...
    fun `System returns http status 404 if the gss codes retrieved from ERO and the application gss code are different`() {
        ...
        // When the EMS sends a put request to "/proxyvotes" with an application id APPLICATION_ID_2 and certificate serial number ERO_ID_1_CERTIFICATE_SERIAL and SUCCESS status
        val responseSpec =
            apiClient!!.putEmsApplication("/proxyvotes/$APPLICATION_ID_2", serialNumber = ERO_ID_1_CERTIFICATE_SERIAL)
    ...
    fun `System returns http status 204 on successful deletion of a success status`() {
        ...
        // When the EMS sends a put request to "/proxyvotes" with an application id APPLICATION_ID_1 and certificate serial number ERO_ID_1_CERTIFICATE_SERIAL and SUCCESS status
        val responseSpec =
            apiClient!!.putEmsApplication("/proxyvotes/$APPLICATION_ID_1", serialNumber = ERO_ID_1_CERTIFICATE_SERIAL)
    ...
    fun `System returns http status 204 on successful deletion of a failure status`() {
        ...
        // When the EMS sends a put request to "/proxyvotes" with an application id APPLICATION_ID_1 and certificate serial number ERO_ID_1_CERTIFICATE_SERIAL and FAILURE status
        val responseSpec =
