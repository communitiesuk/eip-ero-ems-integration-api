...
class DeletePostalVoteApplicationsIntegrationTest : IntegrationTest() {
    ...
    fun `System returns http status 403 if certificate serial number is not attached to the request`() {
        ...
        val responseSpec = apiClient!!.delete("/postalvotes/502cf250036469154b4f85fb", attachSerialNumber = false)
    ...
    fun `System rejects the request with status code 400 if the application id format is invalid`() {
        ...
        val responseSpec = apiClient!!.delete("/postalvotes/123", serialNumber = "1234567891")
    ...
    fun `System returns http status 404 if a given application does not exist`() {
        ...
        val responseSpec = apiClient!!.delete("/postalvotes/502cf250036469154b4f85fb", serialNumber = "1234567891")
    ...
    fun `System returns http status 404 if the gss codes retrieved from ERO and the application gss code are different`() {
        ...
        val responseSpec = apiClient!!.delete("/postalvotes/502cf250036469154b4f85fc", serialNumber = "1234567891")
