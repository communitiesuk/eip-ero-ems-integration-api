...
dependencies {
    ...
    implementation("io.github.acm19:aws-request-signing-apache-interceptor:4.0.0")
    ...
    implementation("net.javacrumbs.shedlock:shedlock-provider-jdbc-template:7.3.0")
